package net.zyuiop.survivalgames.utils;
...
public class Metadatas {
    public static Object getMetadata(Metadatable object, String key) {
        ...
        for (MetadataValue value : values) {
            ...
            if (value.getOwningPlugin() == SurvivalGames.instance) {
                return value.value();
            }
        }
        return null;
    ...
    public static void setMetadata(Metadatable object, String key, Object value) {
        object.setMetadata(key, new FixedMetadataValue(SurvivalGames.instance,value));
    }
}
