...
public class SoloGame extends BasicGame {
    ...
    public void creditKillCoins(Player player) {
        SamaGamesAPI.get().getPlayerManager().getPlayerData(player.getUniqueId()).creditCoins(20, "Un joueur tué !", true);
    }

    public void checkStump(Player player) {
        if (players.size() == 2)
            SamaGamesAPI.get().getPlayerManager().getPlayerData(player.getUniqueId()).creditCoins(20, "Troisième au classement !", true);

        if (players.size() == 1) {
            SamaGamesAPI.get().getPlayerManager().getPlayerData(player.getUniqueId()).creditCoins(50, "Second au classement !", true);
            SamaGamesAPI.get().getPlayerManager().getPlayerData(player.getUniqueId()).creditStars(1, "Second au classement !");
    ...
    public void win(final Player player) {
        ...
        SamaGamesAPI.get().getPlayerManager().getPlayerData(player.getUniqueId()).creditCoins(100, "Victoire !", true);
        SamaGamesAPI.get().getPlayerManager().getPlayerData(player.getUniqueId()).creditStars(2, "Victoire !", true);
        try {
            SamaGamesAPI.get().getStatsManager("uhcrun").increase(player.getUniqueId(), "victories", 2);
