...
public class SavedPlayer {
	...
	private HashMap<String, DamageDone> damageDone = new HashMap<>();
	private HashMap<String, DamageReceived> damageTaken = new HashMap<>();
	...
	public void doDamage(DamageDone damage) {
		DamageDone stored = damageDone.get(damage.getIdentification());
		if (stored == null)
			stored = damage;
		else
	...
	public void takeDamage(DamageReceived received) {
		DamageReceived stored = damageTaken.get(received.getIdentification());
		if (stored == null)
			stored = received;
		else
	...
	public HashMap<String, DamageDone> getDamageDone() {
		return damageDone;
	}

	public HashMap<String, DamageReceived> getDamageTaken() {
		return damageTaken;
	}
